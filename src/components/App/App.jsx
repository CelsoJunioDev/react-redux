...
import { selectAllProducts, selectSelectedeProductTotalPrice, selectSelectedProducts } from '../../store/Products/Products.selectors'
...
function App () {
  ...
  const totalPrice = useSelector(selectSelectedeProductTotalPrice)
